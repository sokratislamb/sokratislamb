...
public class MultiPizza {
    public static void main(String[] args) {
        ...
        // By adding one, i get 1st,2nd,3rd,4th and 5th position that sound more natural and useful to the end user and prevent confusion.
